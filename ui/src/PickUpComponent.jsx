...
class PickUpComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
PickUpComponent.contextType = UserContext;

const PickUpComponentWrapped = withRouter(PickUpComponent);
delete PickUpComponentWrapped.contextType;
export default PickUpComponentWrapped;
