...
class SignInNavItem extends React.Component {
  ...
  async signIn() {
    ...
    try {
      ...
      const { signedIn, givenName, name , email, address, phone, orderNumbers } = result;
      const { onUserChange } = this.props;
      onUserChange({ signedIn, givenName, name , email, address, phone, orderNumbers });
    } catch (error) {
...
export default withToast(withRouter(SignInNavItem));
